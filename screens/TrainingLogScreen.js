...
const TrainingLogScreen = ({navigation}) => {
    ...
    useEffect(()=>{
      axios.get(apiName+"/api/my-training-log",{headers})
      .then((r)=>{
        setData(r.data)
        console.log("Training log is ready")
      })
    ...
    return (
      ...
      <TextInfo text="My Training Log"></TextInfo>
  
      <Trainings trainings={data} navigation={navigation} />
